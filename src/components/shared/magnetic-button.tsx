...
export function MagneticButton({
  ...
  return (
    <a
      className={cn(
        "group inline-flex min-h-8 items-center justify-center gap-3 rounded-full border px-4 py-2 text-sm font-semibold tracking-[0.02em] transition-[border-color,background-color,color,box-shadow] duration-300 will-change-transform max-sm:w-full",
        variant === "primary"
